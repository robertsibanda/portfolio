      ...
      <div className="about-grid">
        <div className="about-card glass">
          ...
          <p className="about-card-text">
            I'm an ATS agent at 1-grid, currently based in Cape Town, South Africa.
        ...
        <div className="about-card glass">
          ...
          <h3 className="about-card-title">Publications</h3>
          <div className="about-card-text">
            <p style={{ marginBottom: 8 }}>
              A Blockchain-based Solution to Enhance Security and Privacy in
              Electronic Health Record Management Systems
            </p>
            <a
              href="https://papers.academic-conferences.org/index.php/ecie/article/view/2606"
              target="_blank"
              rel="noopener noreferrer"
              className="publication-link"
            >
              European Conference on the Impact of Artificial Intelligence and Robotics (ECIE) — View Paper →
            </a>
          </div>
        </div>
      </div>
